...
from .views import GetBrand,GetMobile,GetRoleReviewProductView,GetTopBuyProductView,GetListProductCompareView
urlpatterns = [
    path("get-brand", GetBrand.as_view(), name="get-brand"),
    path("get-product", GetMobile.as_view(), name="get-product"),
    path("get-list-product-compare", GetListProductCompareView.as_view(), name="get-list-product-compare"),
